...
def parse_json_with_retry(
    output: str, attempt: int, max_retries: int, original_prompt: str
) -> dict:
...
def match_terminology(translation: str, terms: dict[str, str]) -> list[dict[str, str]]:
...
def get_terminology_fields(entry: dict) -> tuple[dict[str, str], dict[str, str] | None]:
